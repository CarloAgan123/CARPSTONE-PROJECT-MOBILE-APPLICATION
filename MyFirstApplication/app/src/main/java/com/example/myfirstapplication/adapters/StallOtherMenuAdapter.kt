...
class StallOtherMenuAdapter : RecyclerView.Adapter<StallOtherMenuAdapter.StallOtherMenuViewHolder> () {

    inner class StallOtherMenuViewHolder(private val binding: PreOrderItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StallOtherMenuViewHolder {
        val binding = PreOrderItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return StallOtherMenuViewHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: StallOtherMenuViewHolder, position: Int) {

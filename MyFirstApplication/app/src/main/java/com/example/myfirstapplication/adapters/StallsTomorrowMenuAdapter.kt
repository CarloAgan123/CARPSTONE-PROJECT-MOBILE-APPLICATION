...
class StallsTomorrowMenuAdapter: RecyclerView.Adapter<StallsTomorrowMenuAdapter.StallTomorrowMenuViewHolder>(){

    inner class StallTomorrowMenuViewHolder(private val binding: PreOrderItemBinding) : RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StallTomorrowMenuViewHolder {
        val binding = PreOrderItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return StallTomorrowMenuViewHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: StallTomorrowMenuViewHolder, position: Int) {

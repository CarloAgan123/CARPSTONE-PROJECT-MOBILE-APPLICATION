...
class DishCategoryAdapter: RecyclerView.Adapter<DishCategoryAdapter.DishCategoryViewHolder>() {

    inner class DishCategoryViewHolder(private val binding: SpecialRvItemBinding) : RecyclerView.ViewHolder(binding.root) {

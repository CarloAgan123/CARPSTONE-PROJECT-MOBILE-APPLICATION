...
class TransactionHistoryDeclinedAdapter: RecyclerView.Adapter<TransactionHistoryDeclinedAdapter.TransactionHistoryDeclinedViewHolder> (){

    inner class TransactionHistoryDeclinedViewHolder(private val binding: TransactionHistoryListItemBinding):RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onBindViewHolder(holder: TransactionHistoryDeclinedViewHolder, position: Int) {

...
import com.example.myfirstapplication.databinding.TransactionHistoryListItemBinding

class TransactionHistoryCancelledAdapter: RecyclerView.Adapter<TransactionHistoryCancelledAdapter.TransactionHistoryCancelledViewHolder>() {
    inner class TransactionHistoryCancelledViewHolder(private val binding: TransactionHistoryListItemBinding):RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TransactionHistoryCancelledViewHolder {
        val binding = TransactionHistoryListItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return TransactionHistoryCancelledViewHolder(binding)
    }
    ...
    override fun onBindViewHolder(holder: TransactionHistoryCancelledViewHolder, position: Int) {

...
class TransactionHistoryReceiveAdapter: RecyclerView.Adapter<TransactionHistoryReceiveAdapter.TransactionHistoryReceiveViewHolder>() {

    inner class TransactionHistoryReceiveViewHolder(private val binding: TransactionHistoryListItemBinding):RecyclerView.ViewHolder(binding.root) {
    ...
    override fun onBindViewHolder(holder: TransactionHistoryReceiveViewHolder, position: Int) {
